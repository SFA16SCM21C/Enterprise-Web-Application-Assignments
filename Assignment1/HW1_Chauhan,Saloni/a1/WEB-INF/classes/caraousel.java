...
public class caraousel extends HttpServlet{
...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
    	...
    	out.println("<div class='title'><h3>Suggested Accesories for your product<h3>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/a1/images/wasc1.jpg'  align='center' width='50' height='50'>");
      out.println("<h5 style = 'color: #990000;'> Apple Sports band</h5>");
      
		out.println("<h5 style = 'color: #990000;'> Price:49.99$</h5>");
       out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Apple Sports band - 42 mm'>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/wasc2.jpg'  align='center' width='200' height='200'>");
       out.println("<h5 style = 'color: #990000;'> Screen Protector </h5>");
       out.println("<h5 style = 'color: #990000;'> Price:19.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Screen Protector'>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/a1/images/wasc3.jpg'  align='center' width='200' height='200'>");
	  out.println("<h5 style = 'color: #990000;'> Insginia Apple watch</h5>");
	  out.println("<h5 style = 'color: #990000;'> Price:12.99$</h5>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insginia Apple watch charging cable'>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/wasc4.jpg'  align='center' width='200' height='200'>");
       out.println("<h5 style = 'color: #990000;'>Gear S3 Wireless Carging Dock</h5>");
       out.println("<h5 style = 'color: #990000;'> Price:39.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Gear S3 Wireless Charging Dock'>");
    ...
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/a1/images/wasc5.jpg'  align='center' width='200' height='200'>");
       out.println("<h5 style = 'color: #990000;'> iPhone and Apple Watch</h3>");
       out.println("<h5 style = 'color: #990000;'> Price:79.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Nomad - Apple Watch Stand'>");
      out.println("<input type='hidden' name='price' value='79.99'>");
out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000' type='submit' value='Buy Now'>");
      out.println("</form>");
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/a1/images/wasc6.jpg'  align='center' width='200' height='200'>");
       out.println("<h5 style = 'color: #990000;'>Samsung - Gear S2 Wireless Charger </h5>");
       out.println("<h5 style = 'color: #990000;'> Price:39.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value=' Samsung Gear S2 Wireless Charger'>");
      out.println("<input type='hidden' name='price' value='39.99'>");
out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000' type='submit' value='Buy Now'>");
      out.println("</form>");
