...
public class caraousel2 extends HttpServlet{
...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/csj/images/headphoneasc1.jpg'  align='center' width='150' height='150'>");
      out.println("<h3> Insignia Charging Case For Most </h3>");
       out.println("<h3> Wireless Earbud</h3>");
		out.println("<h3> Price:19.99$</h3>");
       out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insignia wiress Charging case '>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/csj/images/headphoneasc2.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Insigna Accesories </h3>");
        out.println("<h3> For Apple airpods</h3>");
       out.println("<h3> Pirce:19.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insignia Accessories For Airpods'>");
      out.println("<input type='hidden' name='price' value='19.99'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/csj/images/headphoneasc3.jpg'  align='center' width='250' height='250'>");
	  out.println("<h3> Belkin 2' Headphone</h3>");
	  out.println("<h3> Splitter</h3>");
	  out.println("<h3> Price:11.99$</h3>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Belkin 2' Headphone Splitter'>");
      out.println("<input type='hidden' name='price' value='11.99'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/csj/images/headphoneasc4.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Jaybird Premium</h3>");
       out.println("<h3> Foam Comfort Ear Tip Kit</h3>");
       out.println("<h3> Price:5.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Jaybird Premium Foam Comfort Ear Tip Kit'>");
    ...
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/csj/images/headphoneasc5.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>ReTrak Bluetooth </h3>");
       out.println("<h3> Auxillary to 3.5mm adapter</h3>");
       out.println("<h3> Price:14.98$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='ReTrak BluetoothAuxillary to 3.5mm adapter '>");
      out.println("<input type='hidden' name='price' value='14.98'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/csj/images/headphoneasc6.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>JLAB Gravity Bluetooth  </h3>");
       out.println("<h3> Neckband Adapter with Earbuds </h3>");
       out.println("<h3> Price:39.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='JLAB Gravity Bluetooth - Neckband Adapter with Earbuds '>");
