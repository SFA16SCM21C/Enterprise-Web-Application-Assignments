...
public class salesproductreport extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		...
		HashMap<String, prod> prodd =new HashMap<String, prod>();
        prodd=obj.report1();
    	...
    	out.println("<p>");
    	out.println("<h3>Below is the Product Sales Reports </h3>");
		out.println("<table border='1'>");
		out.println("<tr>");
		out.println("<th> Product Name : </th>");
		out.println("<th> Quantity Sold : </th>");
		out.println("<th> Entire Sales : </th>");
		out.println("</tr>");
		int i=0;
		for (String key : prodd.keySet())
		 {
		  prod con= prodd.get(key);
		  String itemName = con.getName(); 
		  int cnt=con.getCnt();
		  double sale=con.getTotalSale();
