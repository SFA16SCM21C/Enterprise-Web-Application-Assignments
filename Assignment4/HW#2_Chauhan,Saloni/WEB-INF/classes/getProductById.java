...
public class getProductById extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		...
		String var=request.getParameter("searchId");
    	...
    	out.println("<p>");
    	out.println("<h5>Product Id: "+var+"</h5>");
    	out.println("<p>");
    	...
    	
		 {
		  ...
		  if(itemId.equals(var))
		  {
		  out.println("<h4>");
		  out.println("<img src='"+imgname+"' align='center' width='150' height='150'>");	
		  out.println("<br>");
		  out.println("<br>");
		  out.println("<br>");
		  //out.println("Product ID: "+itemId);
		  out.println("<br>");
		  out.println("<i>Product Name : </i>"+itemName);
		  out.println("<br>");
		  out.println("<i>Price :</i> $ "+price);

		  out.println("<br>");
		  out.println("<i>Retailer : </i> "+retailername);
		  out.println("<br>");
	
		  out.println("<i> Condition : </i>"+condition);
		  out.println("<br>");
		  out.println("<i> On Sale (Yes / NO) : </i>"+sale);
		  out.println("<br>");
		  out.println("<form action='buy'>");
		  out.println("<br>");
          out.println("<input type='submit' value='Buy Now' style='height:30px; width:90px; font-weight: bold;' >");
    	...
    	//out.println("<img src='images/banner.png' width='670' height='500; alt='' />");
