...
public class inventoryreport extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		...
		out.println("<form action='productquantity'>");
		...
		//products for sale
		out.println("<form action='productsales'>");
		...
		//products on rebate
		out.println("<form action='productrebate'>");
		...
		out.println("<form action='chartinventory'>");
