...
public class caraousel3 extends HttpServlet{
...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/csj/images/phoneasc1.jpg'  align='center' width='150' height='150'>");
      out.println("<h3> ReTrak Finger/Grip </h3>");
       out.println("<h3> KickStand For Mobiles</h3>");
		out.println("<h3> Price:9.99$</h3>");
       out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='IReTrak Finger/Grip Kickstand for Mobiles '>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/csj/images/phoneasc2.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Samsung Fast </h3>");
        out.println("<h3> Wireless Charger</h3>");
       out.println("<h3> Pirce:39.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Samsung Fast Wireless Charger'>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/csj/images/phoneasc3.jpg'  align='center' width='250' height='250'>");
	  out.println("<h3>Bracktekon Desk/Dash</h3>");
	  out.println("<h3> Mount for phone</h3>");
	  out.println("<h3> Price:17.99$</h3>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Bracktekon Desk/Dash Mount for phone>");
      out.println("<input type='hidden' name='price' value='17.99'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/csj/images/phoneasc4.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Dynex Apple MFI</h3>");
       out.println("<h3> Lightning USB Cable</h3>");
       out.println("<h3> Price:7.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Dynex Apple MFI Lightning USB Cable'>");
      out.println("<input type='hidden' name='price' value='7.99'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/csj/images/phoneasc5.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>EMTECT Power CLip </h3>");
       out.println("<h3> Battery</h3>");
       out.println("<h3> Price:33.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='EMTEC - Power Clip Battery'>");
      out.println("<input type='hidden' name='price' value='33.99'>");
      out.println("<h4>BUY BUTTON BELOW</h4>");
      out.println("<input type='submit' value='SUBMIT'>");
      out.println("</form>");
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/csj/images/phoneasc6.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Mophie - Juice Pack   </h3>");
       out.println("<h3> Reserve External Battery </h3>");
