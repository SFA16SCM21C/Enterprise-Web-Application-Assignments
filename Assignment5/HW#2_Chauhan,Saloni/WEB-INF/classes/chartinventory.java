...
public class chartinventory extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
      ...
      //	String emailid=(String)session.getAttribute("emailid");
    	...
    	out.println("<p>");
    	out.println("<h3> Displaying Product v/s Quantity Graph in store </h3>");
    ...
    out.println("['Product Name', 'Product Quantity', { role: 'style' }, { role: 'annotation' }],");
                 for (int i=0;i<20; i++)
                 {
					out.println("['"+name[i]+"',"+num[i]+", '#DAC47D', '"+num[i]+"'],");					
			  }
    out.println("]);");
    out.println("var options = {");
    out.println("title: 'Quantity v/s Products Available Graph',");
    out.println("chartArea: {width: '40%',left: 200, top: 50, 'height':800},");
    out.println(" hAxis: {");
    out.println("title: 'Quantity Available in store',");
    out.println("showTextEvery: 1,");
    out.println("minValue: 0");
    out.println(" },");
    out.println(" vAxis: {");
    out.println(" title: 'Item Name in Store',");
    out.println("showTextEvery: 1,");
