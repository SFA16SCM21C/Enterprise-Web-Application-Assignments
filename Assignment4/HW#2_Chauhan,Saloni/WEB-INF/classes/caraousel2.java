...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/a1/images/hasc1.jpg'  align='center' width='150' height='150'>");
      out.println("<hh5 style = 'color: #990000;> Insignia Charging Case For Most </h5>");
		out.println("<hh5 style = 'color: #990000;> Price:19.99$</h5>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/hasc2.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>Insigna Accesories </h5>");
       out.println("<h5 style = 'color: #990000;> Pirce:19.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/a1/images/hasc3.jpg'  align='center' width='250' height='250'>");
	  out.println("<h5 style = 'color: #990000;> Belkin 2' Headphone</h5>");
	  out.println("<h5 style = 'color: #990000;> Price:11.99$</h5>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/hasc4.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>Jaybird Premium</h5>");
       out.println("<h5 style = 'color: #990000;> Price:5.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
    ...
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/a1/images/hasc5.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>ReTrak Bluetooth </h5>");
       out.println("<h5 style = 'color: #990000;> Price:14.98$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
    ...
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/a1/images/hasc6.png'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>JLAB Gravity Bluetooth  </h5>");
       out.println("<h5 style = 'color: #990000;> Price:39.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
