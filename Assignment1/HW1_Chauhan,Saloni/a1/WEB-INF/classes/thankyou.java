...
public class thankyou extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		...
		String next2Week=request.getParameter("next2Week");
        out.println("<html>");
    	...
    	out.println("<p>");
    	out.println("<h3> Thank you "+emailid+" for placing order with us</h3>");
    	out.println("<h3> Continue shopping with us or you can logout </h3>");
    	out.println("<h3> You order Number is: "+count+"</h3>");
		out.println("<h3> You order would deliver at: "+next2Week+"</h3>");
    	out.println("<form action='/a1/warranty.html'>");
    	out.println("<input type='submit' value='Buy Warranty Card'>");
    	out.println("</form>");
