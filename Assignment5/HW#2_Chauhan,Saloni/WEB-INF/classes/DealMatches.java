...
public class DealMatches extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
    	...
    	out.println("<h4>Welcome to Smart Portable !</h4>");
    	out.println("</div>");
    	out.println("<div class='content'>");
		out.println("<p>");
    	out.println("<h5>Please REGISTER and LOGIN before viewing/purchasing any product details</h5></p>");
		out.println("<p><h5> 1.Best Deals ever</h5></p>");
		out.println("<p><h5>2.Heavy Discounts</h5></p>");
		out.println("<p><h5>3.Guarantee Customer Service</h5></p>");
		out.println("<p><h5>4.Easy Purchase and Returns</h5></p>");
		out.println("<form action='readme.html'>");
		out.println("<input type='submit' value='Read Guidelines Here'>");
		out.println("</form>");
		out.println("</p>");
    	...
    	String filename="C:/Users/teleworld/Desktop/apache-tomcat-7.0.34/webapps/a1/WEB-INF/classes/DealMatches.txt";
    	 ...
    	 String str;
    	 HashMap<String, Product> deals =new HashMap<String, Product>();
    	 for(Map.Entry<String, Product>entry:prod.entrySet())
    	  {
 ...
 for (String key : deals.keySet() ) 
        ...
        out.println("<br>");
   		...
   		out.println("<img src='images/back.png' width='670' height='380; alt='' />");
		out.println("</div>");
    	out.println("</div>");
    	out.println("</div></td>");
