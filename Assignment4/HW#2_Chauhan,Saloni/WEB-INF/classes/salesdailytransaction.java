...
public class salesdailytransaction extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
    	...
    	out.println("<p>");
    	out.println("<h3> Total Daily Sales transactions Report </h3>");
		out.println("<table border='1'>");
		out.println("<tr>");
		out.println("<th>Transaction Date : </th>");
		out.println("<th>Entire Sales On specified Date: </th>");
		out.println("</tr>");
