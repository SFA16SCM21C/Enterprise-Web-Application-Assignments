...
public class caraousel5 extends HttpServlet{
...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
    	...
    	out.println("<div class='title'><h3>Suggested Accesory for your product<h3>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/a1/images/stasc1.jpg'  align='center' width='150' height='150'>");
      out.println("<h5 style = 'color: #990000;> Insignia™ - Case for </h5>");
		out.println("<h5 style = 'color: #990000;> Price:4.49$</h5>");
       out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insignia- Case for Most Portable Hard Drives '>");
      out.println("<input type='hidden' name='price' value='4.49'>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/stasc2.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>Insignia - Portable </h5>");
       out.println("<h5 style = 'color: #990000;> Pirce:9.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insignia - Portable Hard Drive Case'>");
      out.println("<input type='hidden' name='price' value='9.99'>");
      out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000;' type='submit' value='Buy Now'>");
      out.println("</form>");
    out.println("</div>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/a1/images/stasc3.jpg'  align='center' width='250' height='250'>");
	  out.println("<h5 style = 'color: #990000;>WD - Carrying Case </h5>");
	  out.println("<h5 style = 'color: #990000;> Price:12.99$</h5>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='WD - Carrying Case HardDisk>");
      out.println("<input type='hidden' name='price' value='12.99'>");
      out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000;' type='submit' value='Buy Now'>");
      out.println("</form>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/stasc4.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>Apricorn - Transfer Cable</h5>");
       out.println("<h5 style = 'color: #990000;> Price:20.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Apricorn - Data Transfer Cable'>");
      out.println("<input type='hidden' name='price' value='20.99'>");
      out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000;' type='submit' value='Buy Now'>");
      out.println("</form>");
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/a1/images/stasc5.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;>TSabrent - Power/Hardware </h5>");
       out.println("<h5 style = 'color: #990000;> Price:28.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Sabrent - Power/Hardware Connectivity Kit'>");
      out.println("<input type='hidden' name='price' value='28.99'>");
      out.println("<h4 style = 'color: #000066'>You can buy the item with a discount</h4>");
      out.println("<input style = 'color: #000000;' type='submit' value='Buy Now'>");
      out.println("</form>");
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/a1/images/stasc6.jpg'  align='center' width='150' height='150'>");
       out.println("<h5 style = 'color: #990000;> Insignia - 2.5 Serial Hard Drive </h5>");
       out.println("<h5 style = 'color: #990000;> Price:29.99$</h5>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
      out.println("<input type='hidden' name='name' value='Insignia - 2.5 Serial ATA Hard Drive Enclosure '>");
