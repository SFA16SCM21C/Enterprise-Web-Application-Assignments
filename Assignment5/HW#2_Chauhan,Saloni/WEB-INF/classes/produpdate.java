...
public class produpdate extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
    	...
    	out.println("<div class='title'><h1>WELCOME to Smart Portable ! </h1>");
    	out.println("</div>");
    	out.println("<div class='content'>");
    	out.println("<p>");
    	out.println("<h1> Welcome StoreManager -  "+emailid+"</h1>");
    	
    	out.println("<h1>Product Updation</h1>");
    	
    	
    out.println("<form action='/csj/addproducts.html'>");
    	out.println("Add Products");
    	out.println("<br>");
		out.println("<input type='submit' value='ADD Products'>");
		out.println("</form>");
		
		    ;out.println("<form action='/csj/delproducts.html'>");
    	out.println("Delete Products");
    	out.println("<br>");
		out.println("<input type='submit' value='Delete Products'>");
		out.println("</form>");
		
		out.println("<form action='/csj/updateprod.html'>");
    	out.println("Update Products");
    	out.println("<br>");
