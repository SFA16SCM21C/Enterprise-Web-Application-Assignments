...
public class salesreport extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
    	...
    	out.println("<h3>Here are the Sales Reports generated</h3>");
    	
		//reprts generated
		out.println("<form action='salesproductreport'>");
    	out.println("Click below to generate Products Sales Report");
    	out.println("<br>");
		out.println("<br>");
		out.println("<input type='submit' value='Product Sales Report'>");
		out.println("</form>");
		
		//transaction report
		out.println("<form action='salesdailytransaction'>");
    	out.println("Click below to see the Daily Transactions Report");
    	out.println("<br>");
		out.println("<br>");
		out.println("<input type='submit' value='Transaction Report'>");
		out.println("</form>");
		
		//report 2 for viewing them
		out.println("<form action='chartsales'>");
    	out.println("Click for Sales Report of the store");
    	out.println("<br>");
		out.println("<br>");
