...
out.println("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js' integrity='sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa' crossorigin='anonymous'></script>");
  ...
  out.println("<div class='carousel-inner' role='listbox'>");
    out.println("<div class='item active'>");
      ...
      out.println("<img src='/a1/images/storageasc1.jpg'  align='center' width='150' height='150'>");
      out.println("<h3> Insignia™ - Case for </h3>");
       out.println("<h3>Most Portable Hard Drives</h3>");
		out.println("<h3> Price:4.49$</h3>");
...
out.println("</div>");	
    ...
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/storageasc2.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Insignia - Portable </h3>");
        out.println("<h3> Hard Drive Case</h3>");
       out.println("<h3> Pirce:9.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
	...
	out.println("<div class='item'>");
	  out.println("<img src='/a1/images/storageasc3.jpg'  align='center' width='250' height='250'>");
	  out.println("<h3>WD - Carrying Case </h3>");
	  out.println("<h3> HardDisk</h3>");
	  out.println("<h3> Price:12.99$</h3>");
	  out.println("<br>");
	  out.println("<div class='carousel-caption'>");
	    out.println("<form action='buy'>");
	...
	out.println("</div>");
	 out.println("</div>");	
    out.println("<div class='item'>");
      out.println("<img src='/a1/images/storageasc4.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>Apricorn -</h3>");
       out.println("<h3> Transfer Cable</h3>");
       out.println("<h3> Price:20.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
    ...
    out.println("</div>");
     ...
     out.println("<div class='item'>");
      out.println("<img src='/a1/images/storageasc5.jpg'  align='center' width='150' height='150'>");
       out.println("<h3>TSabrent - Power/Hardware </h3>");
       out.println("<h3> Connectivity Kit</h3>");
       out.println("<h3> Price:28.99$</h3>");
       out.println("<br>");
          out.println("<div class='carousel-caption'>");
     out.println("<form action='buy'>");
    ...
    out.println("</div>");
     out.println("</div>");
      ...
      out.println("<div class='item'>");
      out.println("<img src='/a1/images/storageasc6.jpg'  align='center' width='150' height='150'>");
       out.println("<h3> Insignia - 2.5 Serial </h3>");
       out.println("<h3>  ATA Hard Drive Enclosure </h3>");
